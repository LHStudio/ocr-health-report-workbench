...
- 营养评价：按已核对的食物数据生成营养 PDF 或 Excel，支持修改人员资料、评价和建议；蛋类数量按每个 45 克折算。
- 体成分合并：可选上传 InBody 等体成分报告；系统识别性别、整数年龄、身高、体重及“去脂体重 / 瘦体重 / Fat Free Mass”，按姓名唯一匹配到食物问卷人员，并自动回填营养报告个人信息。
...
3. 开始识别。系统从体成分表格提取性别、年龄、身高、体重和去脂体重；设备给出小数年龄时只取整数，并只在姓名能唯一匹配时写入对应人员。
4. 打开“营养评价与报告”。这些资料会自动显示在个人信息中，也可人工修订后导出 PDF 或 Excel。
